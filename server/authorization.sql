...
CREATE TABLE `section` (
  ...
  `section_active` tinyint NOT NULL DEFAULT '1',
...
CREATE TABLE `type` (
  ...
  `type_active` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`type_id`),
  KEY `type_area_id_idx` (`area_id`),
  KEY `type_level_id_idx` (`level_id`),
  CONSTRAINT `type_area_id` FOREIGN KEY (`area_id`) REFERENCES `area` (`area_id`),
  CONSTRAINT `type_level_id` FOREIGN KEY (`level_id`) REFERENCES `level` (`level_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `person` (
  ...
  KEY `person_type_id_idx` (`type_id`),
  CONSTRAINT `person_type_id` FOREIGN KEY (`type_id`) REFERENCES `type` (`type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-02-03 16:15:20